...
type FileKey = (typeof FIELDS)[number]["key"];
...
export function ImportForm() {
  ...
  const canImport = Object.values(files).some(Boolean);
    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-border bg-surface p-6">
        <p className="mb-4 text-xs text-muted-foreground">
          Tous les fichiers sont optionnels — importez ce que vous avez sous la main. Account Detail, Invoice Number et
          Product et KPI se rapprochent des comptes déjà en base par leur nom.
        </p>
