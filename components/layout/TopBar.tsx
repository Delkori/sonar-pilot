export function TopBar({
  ...
  return (
    <header // `top-14` sous lg : la barre de navigation mobile occupe déjà le
      // haut de l'écran — collées toutes deux à 0, elles se superposaient.
      className="sticky top-14 z-10 border-b border-border bg-surface/80 px-4 py-4 backdrop-blur sm:px-6 lg:top-0 lg:px-8 lg:py-5">
