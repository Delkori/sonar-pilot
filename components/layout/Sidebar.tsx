...
import { LayoutDashboard, Users, Map, Radar, LogOut, Grid3x3, Gamepad2, CalendarClock, HandCoins, Settings, Fingerprint, Activity } from "lucide-react";
...
const items = [
  ...
  { href: "/sonarscore", label: "SonarScore (bêta)", icon: Activity },
